...
const Camp = () => {
  return (
    <>
      <div className="w-full flex items-center justify-between bg-gradient-to-r from-gray-950 via-gray-500 to-gray-950 h-fit p-[1px] mt-8">
        <div className="h-fit w-full bg-slate-950 items-center justify-between px-2 py-6">
